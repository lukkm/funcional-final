...
Elm.Styles.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var blueTile = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "border",_1: "1px solid gray"}
                                                 ,{ctor: "_Tuple2",_0: "background-color",_1: "blue"}
                                                 ,{ctor: "_Tuple2",_0: "width",_1: "20px"}
                                                 ,{ctor: "_Tuple2",_0: "height",_1: "20px"}]));
   var greenTile = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "border",_1: "1px solid gray"}
                                                  ,{ctor: "_Tuple2",_0: "background-color",_1: "green"}
                                                  ,{ctor: "_Tuple2",_0: "width",_1: "20px"}
                                                  ,{ctor: "_Tuple2",_0: "height",_1: "20px"}]));
   var yellowTile = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "border",_1: "1px solid gray"}
                                                   ,{ctor: "_Tuple2",_0: "background-color",_1: "yellow"}
                                                   ,{ctor: "_Tuple2",_0: "width",_1: "20px"}
                                                   ,{ctor: "_Tuple2",_0: "height",_1: "20px"}]));
   var redTile = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "border",_1: "1px solid gray"}
   ...
   var inline = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "display",_1: "inline-block"}]));
   var marginLeft = function (size) {
      return $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "margin-left",_1: A2($Basics._op["++"],$Basics.toString(size),"px")}]));
   };
   var marginTop = function (size) {
      return $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "margin-top",_1: A2($Basics._op["++"],$Basics.toString(size),"px")}]));
   };
   var center = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "margin",_1: "0 auto"}]));
...
Elm.Main.make = function (_elm) {
   ...
   var updateBoard = F5(function (board,x,y,originalColor,nextColor) {
      ...
      $Utils.sizeOf(board)) > 0 || !_U.eq(A3($Utils.getM,board,x,y),originalColor))))) return board; else {
   ...
   var changeColor = F2(function (model,tile) {
      var oned = $Debug.log("(toString (getBoardStatus model.board))");
      var one = $Debug.log($Basics.toString(getBoardStatus(model.board)));
      return {board: A5(updateBoard,model.board,1,1,A2($Utils.getL,A2($Utils.getL,model.board,1),1),tile),status: getBoardStatus(model.board)};
   });
   ...
   var getWonView = A2($Html.div,_U.list([$Styles.center]),_U.list([$Html.text("You win")]));
   ...
   var view = F2(function (address,model) {
      ...
      switch (_p1.ctor)
      {case "Starting": return A2(getGameView,address,model);
         case "InGame": return A2(getGameView,address,model);
         default: return getWonView;}
   });
   var init = {board: getRandomBoard,status: $Utils.InGame};
